...
class WSIVMissionsNextRequest {
	...
	public function __construct($idLine, $stationName, $directionSens) {
		...
		$this->version  = 0;
		$this->client   = new SoapClient(null, array('location' => $this->location, 'uri' => ""));
	...
	public function getTime() {return strtotime($this->date); }
	public function getLine() { return $this->line; }
	public function getPerturbations() { return $this->perturbations; }
	public function getMissions() { return $this->missions; }
	private function getXML() {
		...
		if (!$this->incrementAndCheckIsAllowed()) { echo "{\"success\": false, \"response\”: \"Error in WSIVMissionsNextRequest.php\"}"; die; }
	...
	private function incrementAndCheckIsAllowed() {
		...
		if (!file_exists($filename)) { file_put_contents($filename, 1); return true; }
